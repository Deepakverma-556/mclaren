    ...
    return (
        <div className='bg-hero bg-cover bg-center bg-no-repeat overflow-hidden'>
            ...
            <div className='max-w-[1215px] mx-auto px-4 pt-[68px] pb-[512px] max-lg:pb-[657px] max-lg:pt-[71px] max-md:pt-[39px] max-md:pb-[380px]'>
                <h1 className='font-notoSans font-bold text-[61px] leading-[83px] text-white max-w-[1072px] text-center pb-[15px] max-lg:pb-[53px] max-md:text-3xl max-md:leading-[40.86px] max-md:pb-[14px] max-lg:max-w-[753px] max-md:max-w-[374px] mx-auto'>Driving Transformation for Performance and Passion Within</h1>
